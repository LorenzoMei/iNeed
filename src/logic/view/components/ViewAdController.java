...
import logic.view.ViewAd;
import logic.view.ViewCheckAnswers;
    ...
    @FXML protected void handleBActionOnAd(ActionEvent event) {
    	...
    	if (((Button) event.getSource()).getText().compareTo(BLabels.ANSWER.getLabel()) == 0) {
    		...
    		try {
				...
				alert.setContentText(String.format("You succefully submitted your answer to the owner of the ad, %nwho will contact you if he wants to trade favors with you" ));
