...
public enum XPaths {
	...
	MAKEANAD_OFFERTYPE("/html/body/div/div[2]/div/div/div/form/div[1]/select/option[2]"),
	MAKEANAD_REQUESTTYPE("/html/body/div/div[2]/div/div/div/form/div[1]/select/option[1]"),
	MAKEANAD_FTITLE("//*[@id=\"title\"]"),
	MAKEANAD_SCATEGORY("//*[@id=\"category\"]"),
	MAKEANAD_GARDERINGCATEGORY("/html/body/div/div[2]/div/div/div/form/div[2]/select/option[3]"),
